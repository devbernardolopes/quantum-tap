...
const ACCELERATOR_INITIAL_COST: int = 10
const ACCELERATOR_COST: int = 10
...
const QUANTA_LEVELS: int = 2048
const QUANTA_GOAL: int = QUANTA_GOAL_HARD
const QUANTA_GOAL_DEBUG: int = 100
const QUANTA_GOAL_EASY: int = 775807
const QUANTA_GOAL_NORMAL: int = 1551614
const QUANTA_GOAL_MEDIUM: int = 3103228
const QUANTA_GOAL_HARD: int = 930968400
const QUANTA_GOAL_ULTRA_HARD: int = 9223372036854775807
